...
func _ready():
	my_global_script.animated_scene([
		...
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["I woke up Monday morning as normal and found some mail which had been left unnoticed on the ground."]},
		...
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["By law I need to sleep for at least 2 hours a night, so my boss don't lose his job for violating our health insurance."]},
	])
