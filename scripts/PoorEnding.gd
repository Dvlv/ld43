...
func _ready():
	...
	my_global_script.animated_scene([
		...
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["This was it. The gun was loaded. "]},
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["Well, I was the gun. Or maybe the bullet."]},
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["Either way. I was fired."]},
		...
		{"target": DIALOGUE, "method": "show_dialogue", "args": ["Bayliffs are coming tomorrow. I'll go back and protect her from them. Help her empty the house."]},
